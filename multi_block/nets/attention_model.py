...
class AttentionModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.init_embed = nn.Linear(node_dim, embedding_dim, device='cuda')
    ...
    def _init_embed(self, input):
        # TSP
        return self.init_embed(input['orders_coords_std'])
    ...
    def _inner(self, input, embeddings):
        ...
        state = self.problem.make_state(input['orders_coords_std'])
